                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">35, 7up Road, Oluyole Ibadan Oyo State</span> <br>
										<span class="text-white">35, 7up Road, Oluyole Ibadan, Oyo State</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+234-7059-075-269</span>
										<span class="text-white">+243-8160-375-988 </span>
									</div>
                                </li>
								...
								<form class="w-100" action="#" method="post">
									<div class="row">
										<div class="row mb-4">
											...
											<div class="form-group col-lg-6">
												<input type="text"  name="phone" class="form-control" placeholder="Phone" maxlength="12">
											</div>
											<div class="form-group col-lg-6">
