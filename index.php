                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus iure consectetur excepturi?.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Est voluptates ducimus neque.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property WHERE city='city'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['pid']?>"><?php echo $row['state'];?></a></h4>
                                    <span><?php 
												$total = $row[0];
